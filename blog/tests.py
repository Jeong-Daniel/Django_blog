...
class TestView(TestCase):
    def setUp(self):
        ...
        self.commnet_001 = Commnet.objects.create(
            post=self.post_001,
            author=self.user_obama,
            content='첫번째 덧글 입니다.'
        )
    ...
    def test_post_detail(self):
        ...
        #commnet area
        comments_area = soup.find('div', id='commnet-area')
        comment_001_area = comments_area.find('div', id='commnet-1')
        self.assertIn(self.commnet_001.author.username, comment_001_area.text)
        self.assertIn(self.commnet_001.content, comment_001_area.text)
